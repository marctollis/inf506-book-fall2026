...
who |>
  pivot_longer(cols = starts_with("new"),
               ...
               values_to = "cases",
               values_drop_na = TRUE) |>
  separate(key, into = c("new", "type", "sex_age"), sep = "_") |> # separate the key column
  separate(sex_age, into = c("sex", "age"), sep = 1) # take the new sex_age column and split it by the first position
```
