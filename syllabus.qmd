...
We will use the learning management system, [Canvas](https://canvas.nau.edu/), to conduct some course business, including assignment disbursement and submitting. I will record lectures/demos, and will make them available in batches before each quiz.
...
| 10 | Oct 26 / Oct 28 | [Ch. 12 through 18 – Transform (continued)](https://r4ds.hadley.nz/transform.html) | [**Factors & Categorical Data**](https://marctollis.github.io/inf506-book-fall2026/factors.html): `forcats` | PS9 | Quiz 4 (Wednesday) |
| 11 | Nov 2 / Nov 4 | [Ch. 19 – Joins](https://r4ds.hadley.nz/joins.html) | [**Table Joins**](https://marctollis.github.io/inf506-book-fall2026/relational.html): joining tables (`left_join`, etc.) | PS10 |  |
...
- **Use of Artificial Intelligence Tools:** AI tools may be used on take-home assignments for explanation and debugging, but students must understand and verify all submitted work and disclose any AI assistance. **AI tools may not be used on quizzes or the in-class final unless explicitly permitted.**

### University Policies

The following required NAU Syllabus Policy Statements apply to this course.

{{< include nau-policies.qmd >}}
